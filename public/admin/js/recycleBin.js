...
if(buttonReset.length>0){
    const formResetItem=document.querySelector("#form-reset-item");
    const path=formResetItem.getAttribute("data-path");
    buttonReset.forEach(button=>{
        button.addEventListener("click",()=>{
            ...
            if(isConfirm){
                ...
                formResetItem.action=action;

                //Dùng hàm submit() để gửi form lên backend.
                formResetItem.submit();
